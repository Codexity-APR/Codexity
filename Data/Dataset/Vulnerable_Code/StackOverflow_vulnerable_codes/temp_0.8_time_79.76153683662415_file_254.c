...
int main() {
    // Example usage of executePipedCommands function
    Cmd command1 = (Cmd) malloc(sizeof(struct cmd_t));
    command1->nargs = 2;
    command1->maxargs = 2;
    command1->args = (char**) malloc(sizeof(char*) * (command1->maxargs));
    command1->args[0] = "ls";
    ...
    command2->nargs = 3;
    command2->maxargs = 3;
    command2->args = (char**) malloc(sizeof(char*) * (command2->maxargs));
    command2->args[0] = "grep";
    command2->args[1] = "pattern";
