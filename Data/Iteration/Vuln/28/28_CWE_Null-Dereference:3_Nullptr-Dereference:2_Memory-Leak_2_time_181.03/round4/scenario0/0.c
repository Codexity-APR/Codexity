...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 49 by call to `malloc`, is not freed after the last access at line 55, column 13.
 Example: 
  53.                 free(tokens[j]);
  54.             }
  55.             free(tokens);
...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 18 by call to `tokenize()`, is not freed after the last access at line 29, column 9.
 Example: 
  27.             free(tokens[i]);
  28.         }
  29.         free(tokens);
