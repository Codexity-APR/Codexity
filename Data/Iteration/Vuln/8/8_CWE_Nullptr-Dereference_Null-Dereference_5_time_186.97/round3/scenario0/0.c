...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 13 by call to `malloc`, is not freed after the last access at line 19, column 13.
 Example: 
  17.                 free(y_td[j]);
  18.             }
  19.             free(y_td);
