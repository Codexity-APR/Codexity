...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 46 by call to `td()`, is not freed after the last access at line 58, column 5.
 Example: 
  56.         free(result[i]);
  57.     }
  58.     free(result);
