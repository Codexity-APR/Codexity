...
Error: Null Dereference   pointer `command3` last assigned on line 104 could be null and is dereferenced at line 105, column 5.
 Example: 
  103. 
  104.     Cmd command3 = malloc(sizeof(struct cmd_t));
  105.     command3->nargs = 1;
           ^
  106.     command3->maxargs = 0;
  107.     command3->args = NULL;
...
Error: Null Dereference   pointer `command2` last assigned on line 96 could be null and is dereferenced at line 97, column 5.
 Example: 
  ...
  99.     command2->args = malloc((command2->maxargs + 1) * sizeof(char *));
...
Error: Null Dereference   pointer `command1->args` last assigned on line 91 could be null and is dereferenced at line 92, column 5.
 Example: 
  ...
  92.     command1->args[0] = "ls";
          ^
  93.     command1->args[1] = NULL;
  94.     command1->next = NULL;
...
int main() {
    ...
    command1->nargs = 2;
    command1->maxargs = 2;
    command1->args = malloc((command1->maxargs + 1) * sizeof(char *));
    command1->args[0] = "ls";
    ...
    command2->nargs = 2;
    command2->maxargs = 2;
    command2->args = malloc((command2->maxargs + 1) * sizeof(char *));
