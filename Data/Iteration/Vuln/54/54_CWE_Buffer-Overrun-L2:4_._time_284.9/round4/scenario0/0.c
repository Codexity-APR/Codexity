...
Error: Buffer Overrun L2   Offset: [3, 9] Size: 4.
 Example: 
  73.         int ones_digit = n % 10;
  74.         sprintf(str, "%s Thousand ", digits[thousands_digit]);
  75.         strcat(str, digits[hundreds_digit]);
              ^
  76.         strcat(str, " Hundred ");
  77.         if (tens_digit == 0)
...
Error: Buffer Overrun L2   Offset: [3, 9] Size: 4.
 Example: 
  62.             {
  63.                 strcat(str, "-");
  64.                 strcat(str, digits[ones_digit]);
                      ^
  65.             }
  66.         }
...
Error: Buffer Overrun L2   Offset: [3, 9] Size: 4.
 Example: 
  50.         if (tens_digit == 0)
  51.         {
  52.             strcat(str, digits[ones_digit]);
                  ^
  53.         }
  54.         else if (tens_digit == 1)

Error: Buffer Overrun L2   Offset: [3, 9] Size: 4.
 Example: 
  27.     if (n < 20)
  28.     {
  29.         strcpy(str, digits[n]);
              ^
  30.     }
  31.     else if (n < 100)
...
int main()
{
    ...
    scanf("%d", &n);
    char str[1000] = ""; // Increased buffer size to accommodate larger strings
    int_to_string(n, str);
