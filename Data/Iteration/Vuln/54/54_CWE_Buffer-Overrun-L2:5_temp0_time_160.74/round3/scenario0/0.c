...
Error: Buffer Overrun L2   Offset: [0, 999] Size: 20 by call to `int_to_string`.
 Example: 
  10.     scanf("%d", &n);
  11.     char str[100] = "";
 ...
 Error type: CWE-788 at line: 57. Error message: Either the condition 'n>9999' is redundant or the array 'digits[20]' is accessed at index 999, which is out of bounds.
