...
Error: Buffer Overrun L3   Offset: [1, +oo] Size: [0, +oo] by call to `shuffle`.
 Example: 
  64.             addCard(temp, deck);
  65.         }
  66.         shuffle(deck);
              ^
  67.         fillHand(7, player1, deck);
  68.         fillHand(7, player2, deck);

 Error type: CWE-457 at line: 188. Error message: Uninitialized variables: cards.value, cards.id, cards.next_card
