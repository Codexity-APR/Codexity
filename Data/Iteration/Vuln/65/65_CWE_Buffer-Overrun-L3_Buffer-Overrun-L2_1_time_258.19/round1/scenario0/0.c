...
Error: Buffer Overrun L3   Offset: [-5, 5] Size: 6.
 Example: 
  ...
  42.   strncpy(word, word_list[word_index], MAX_WORD_LENGTH);
                      ^
  43.   word[MAX_WORD_LENGTH] = '\0';
  44.   word_length = strlen(word);

Error: Buffer Overrun L1   Offset: 20 Size: 20.
 Example: 
  48.     guessed_letters[i] = '_';
  49.   }
  50.   guessed_letters[word_length] = '\0';
        ^
  51. 
  52.   printf("Welcome to Hangman!\n");
