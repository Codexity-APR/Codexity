...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 51 by call to `parse_string()`, is not freed after the last access at line 60, column 5.
 Example: 
  58.         free(tokens[i]);
  59.     }
  60.     free(tokens);
