...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 67 by call to `create_node()`, is not freed after the last access at line 85, column 3.
 Example: 
  83.   add_child(child1, child5);
  84. 
  85.   print_tree(root, 0);
        ^
  86.   
  87.   return 0;
