...
Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 24.
 Example: 
  ...
  39.         FindVariations(passlength, strength, &combo[i], 0, 0);
              ^
...
Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 24.
 Example: 
  ...
  32.             scanf(" %c", &combo[i].letters[j]);
                  ^
  33.         }
  34.

 Error type: CWE-398 at line: 55. Error message: Redundant assignment of 'combo->temp' to itself.
