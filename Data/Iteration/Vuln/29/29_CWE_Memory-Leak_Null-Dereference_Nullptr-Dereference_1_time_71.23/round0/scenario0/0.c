...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 10 by call to `malloc`, is not freed after the last access at line 14, column 5.
 Example: 
