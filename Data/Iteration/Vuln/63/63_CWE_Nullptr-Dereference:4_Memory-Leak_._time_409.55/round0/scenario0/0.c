...
Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 43.
 Example: 
...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 37 by call to `malloc`, is not freed after the last access at line 48, column 5.
 Example: 
  46.     current->next = NULL;
  47.     fclose(words);
  48.     printList(head);
