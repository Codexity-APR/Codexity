...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 94 by call to `addToEnd()`, is not freed after the last access at line 95, column 12.
 Example: 
  93.     node* head = NULL;
  94.     addToEnd(&head, reversed);
  95.     return searchAndDestroy(&head, reversed);
                 ^
  96. }
  97.
