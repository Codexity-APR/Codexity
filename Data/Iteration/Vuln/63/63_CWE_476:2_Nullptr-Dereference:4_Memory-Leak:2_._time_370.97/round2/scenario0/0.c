...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 85 by call to `addToEnd()`, is not freed after the last access at line 86, column 12.
 Example: 
  84.     node* head = NULL;
  85.     addToEnd(&head, reversed);
  86.     return searchAndDestroy(&head, reversed);
                 ^
  87. }
  88.
