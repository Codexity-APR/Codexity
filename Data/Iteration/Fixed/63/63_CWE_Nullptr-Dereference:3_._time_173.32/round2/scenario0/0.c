...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 42 by call to `addToEnd()`, is not freed after the last access at line 45, column 5.
 Example: 
  43.     }
  44.     fclose(words);
  45.     printList(head);
