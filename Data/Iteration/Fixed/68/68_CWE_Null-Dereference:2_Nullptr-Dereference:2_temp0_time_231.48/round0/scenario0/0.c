...
Error: Null Dereference   pointer `newNode` last assigned on line 116 could be null and is dereferenced at line 117, column 5.
 Example: 
  115. {
  116.     node* newNode = (node*)malloc(sizeof(node));
  117.     newNode->data = d;
           ^
  118.     newNode->next = NULL;
  119.

Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 116.
 Example: 
  115. {
  116.     node* newNode = (node*)malloc(sizeof(node));
  117.     newNode->data = d;
...
Error: Null Dereference   pointer `newNode` last assigned on line 103 could be null and is dereferenced at line 104, column 5.
 Example: 
  102. {
  103.     node* newNode = (node*)malloc(sizeof(node));
  104.     newNode->data = d;
           ^
