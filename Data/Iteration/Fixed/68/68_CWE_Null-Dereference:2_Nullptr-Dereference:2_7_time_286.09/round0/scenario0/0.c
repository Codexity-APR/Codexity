...
Error: Null Dereference   pointer `newNode` last assigned on line 139 could be null and is dereferenced at line 140, column 5.
 Example: 
  138. {
...
Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 139.
 Example: 
  138. {
  139.     node* newNode = (node*)malloc(sizeof(node));
  140.     newNode->data = d;
