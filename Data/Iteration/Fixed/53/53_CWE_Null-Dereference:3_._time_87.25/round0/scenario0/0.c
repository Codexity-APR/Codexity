...
Error: Null Dereference   pointer `config->str` last assigned on line 32 could be null and is dereferenced by call to `memset()` at line 39, column 5.
 Example: 
...
Error: Null Dereference   pointer `config->indices` last assigned on line 31 could be null and is dereferenced by call to `memset()` at line 38, column 5.
 Example: 
