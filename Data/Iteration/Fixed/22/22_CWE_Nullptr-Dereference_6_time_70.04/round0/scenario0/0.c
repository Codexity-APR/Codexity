...
Error: Nullptr Dereference   Pulse found a potential null pointer dereference  on line 18.
 Example: 
  18.     clientdata *newClient = (clientdata*) malloc(sizeof(clientdata)); // create a new client
  19. 
  20.     strcpy(newClient->name, name);
          ^
  21.     newClient->birthday = birthday;
  22.     newClient->landline = landline;
