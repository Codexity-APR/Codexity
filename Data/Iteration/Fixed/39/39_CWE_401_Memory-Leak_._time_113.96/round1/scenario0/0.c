...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 34 by call to `malloc`, is not freed after the last access at line 56, column 5.
 Example: 
  54.     first->rest->rest->first = c;
  55.     first->rest->rest->rest = NULL;
  56.     return *first;
          ^
  57. }
  58.

 Error type: CWE-401 at line: 56. Error message: Memory leak: first
