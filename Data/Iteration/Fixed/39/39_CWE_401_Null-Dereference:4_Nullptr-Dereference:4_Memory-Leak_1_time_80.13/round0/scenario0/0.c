...
Error: Null Dereference   pointer `newNode` last assigned on line 35 could be null and is dereferenced at line 36, column 5.
 Example: 
  34. {
  35.     linkedList* newNode = (linkedList*)malloc(sizeof(linkedList));
  36.     newNode->first = a;
          ^
  37.     newNode->rest = NULL;
  38.
...
Error: Memory Leak   Pulse found a potential memory leak. Memory dynamically allocated at line 23 by call to `malloc`, is not freed after the last access at line 30, column 5.
 Example: 
  28.     first->rest->rest->first = c;
  29.     first->rest->rest->rest = NULL;
  30.     return *first;
 ...
 Error type: CWE-401 at line: 30. Error message: Memory leak: first
