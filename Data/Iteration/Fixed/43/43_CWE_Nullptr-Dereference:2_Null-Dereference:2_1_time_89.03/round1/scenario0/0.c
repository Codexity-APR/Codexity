...
Error: Null Dereference   pointer `str` last assigned on line 17 could be null and is dereferenced at line 26, column 26.
 Example: 
  24.     }
  25.     for (size_t i = 0; i <= input_len; ++i) {
  26.         if (is_delimiter(str[i], delimiters) || str[i] == '\0') {
                               ^
  27.             str[i] = '\0';
  28.             tokens[count++] = token_start;
