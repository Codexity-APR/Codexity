...
int main () {
    ...
    if (file) {
        ...
        printf("The contents of the file are: %s", str); // printing the contents of the file
    } else {
        printf("Error opening the file."); // printing an error message if the file cannot be opened
    }
